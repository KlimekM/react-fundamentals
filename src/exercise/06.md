...
This portion was neat and helped cement concepts I was already aware of and use
frequently (i.e. useState, useRef, etc.). One thing that I did pick up was the
htmlFor prop and tying that to a given input to then reference via the id off of

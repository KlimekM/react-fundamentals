...
This exercise was not all that enlightening as it involved string interpolation,
setting props as an object and spreading it into the JSX div which are all
fairly common React practices, but it was fun to play with the Babel REPL to see
how the JSX gets compiled to the React top level APIs in the end.

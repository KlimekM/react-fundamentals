...
The exercise tries to cement the importance of knowing JavaScript APIs to
construct the DOM. This was a simple exercise, but will likely lay the
foundation for how React constructs the virtual DOM and reconciles changes.

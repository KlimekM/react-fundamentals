...
I did not pick up a whole bunch here that I did not already know in regards to
styling React components with the exception of Kent using a self closing div and
not wrapping children in his implementation which is something I was aware of
but don't frequently do.

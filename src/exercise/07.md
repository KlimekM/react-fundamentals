...
Having previously read Kent's blogpost about the key prop and to always use a
unique value and not the array index this exercise was not providing any new
information for me, but the extra credit example was cool when highlighting
given elements and seeing how the behavior differs with the given keys.
